...
.field private static q:Landroidx/appcompat/widget/q1;
...
.field private n:Landroidx/appcompat/widget/r1;
...
.method private constructor <init>(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/q1;->d:Ljava/lang/Runnable;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/q1;->a:Landroid/view/View;

    iput-object p2, p0, Landroidx/appcompat/widget/q1;->b:Ljava/lang/CharSequence;
    ...
    invoke-static {p2}, Lx/g0;->a(Landroid/view/ViewConfiguration;)I

    move-result p2

    iput p2, p0, Landroidx/appcompat/widget/q1;->c:I
...
.method private a()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/q1;->a:Landroid/view/View;

    iget-object v1, p0, Landroidx/appcompat/widget/q1;->d:Ljava/lang/Runnable;
...
.method public static f(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    iget-object v0, v0, Landroidx/appcompat/widget/q1;->a:Landroid/view/View;
    ...
    sget-object p1, Landroidx/appcompat/widget/q1;->q:Landroidx/appcompat/widget/q1;

    if-eqz p1, :cond_1d

    iget-object v0, p1, Landroidx/appcompat/widget/q1;->a:Landroid/view/View;
...
.method private h(Landroid/view/MotionEvent;)Z
    ...
    iget v1, p0, Landroidx/appcompat/widget/q1;->l:I
    ...
    iget v2, p0, Landroidx/appcompat/widget/q1;->c:I
    ...
    iput p1, p0, Landroidx/appcompat/widget/q1;->m:I
...
.method c()V
    ...
    sget-object v0, Landroidx/appcompat/widget/q1;->q:Landroidx/appcompat/widget/q1;

    const/4 v1, 0x0

    if-ne v0, p0, :cond_20

    sput-object v1, Landroidx/appcompat/widget/q1;->q:Landroidx/appcompat/widget/q1;

    iget-object v0, p0, Landroidx/appcompat/widget/q1;->n:Landroidx/appcompat/widget/r1;

    if-eqz v0, :cond_19

    invoke-virtual {v0}, Landroidx/appcompat/widget/r1;->c()V

    iput-object v1, p0, Landroidx/appcompat/widget/q1;->n:Landroidx/appcompat/widget/r1;
...
.method g(Z)V
    ...
    invoke-static {v0}, Lx/x;->v(Landroid/view/View;)Z
    ...
    :cond_14
    sput-object p0, Landroidx/appcompat/widget/q1;->q:Landroidx/appcompat/widget/q1;

    iput-boolean p1, p0, Landroidx/appcompat/widget/q1;->o:Z

    new-instance v1, Landroidx/appcompat/widget/r1;

    iget-object p1, p0, Landroidx/appcompat/widget/q1;->a:Landroid/view/View;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/q1;->a:Landroid/view/View;

    iget v3, p0, Landroidx/appcompat/widget/q1;->l:I

    iget v4, p0, Landroidx/appcompat/widget/q1;->m:I

    iget-boolean v5, p0, Landroidx/appcompat/widget/q1;->o:Z

    iget-object v6, p0, Landroidx/appcompat/widget/q1;->b:Ljava/lang/CharSequence;
    ...
    iget-boolean p1, p0, Landroidx/appcompat/widget/q1;->o:Z
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/q1;->e:Ljava/lang/Runnable;
...
.method public onHover(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/q1;->n:Landroidx/appcompat/widget/r1;
