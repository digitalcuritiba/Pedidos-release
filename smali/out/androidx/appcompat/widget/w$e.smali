...
.field final synthetic T:Landroidx/appcompat/widget/w;
...
.method public constructor <init>(Landroidx/appcompat/widget/w;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/w$e;->T:Landroidx/appcompat/widget/w;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/w$e;->R:Landroid/graphics/Rect;
...
.method O()V
    ...
    iget-object v1, p0, Landroidx/appcompat/widget/w$e;->T:Landroidx/appcompat/widget/w;

    iget-object v1, v1, Landroidx/appcompat/widget/w;->n:Landroid/graphics/Rect;

    invoke-virtual {v0, v1}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object v0, p0, Landroidx/appcompat/widget/w$e;->T:Landroidx/appcompat/widget/w;
    ...
    iget-object v0, v0, Landroidx/appcompat/widget/w;->n:Landroid/graphics/Rect;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/w$e;->T:Landroidx/appcompat/widget/w;

    invoke-virtual {v2}, Landroid/view/View;->getPaddingRight()I

    move-result v2

    iget-object v3, p0, Landroidx/appcompat/widget/w$e;->T:Landroidx/appcompat/widget/w;

    invoke-virtual {v3}, Landroid/view/View;->getWidth()I

    move-result v3

    iget-object v4, p0, Landroidx/appcompat/widget/w$e;->T:Landroidx/appcompat/widget/w;

    iget v5, v4, Landroidx/appcompat/widget/w;->m:I

    const/4 v6, -0x2

    if-ne v5, v6, :cond_78

    iget-object v5, p0, Landroidx/appcompat/widget/w$e;->Q:Landroid/widget/ListAdapter;
    ...
    iget-object v5, p0, Landroidx/appcompat/widget/w$e;->T:Landroidx/appcompat/widget/w;
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/w$e;->T:Landroidx/appcompat/widget/w;

    iget-object v6, v6, Landroidx/appcompat/widget/w;->n:Landroid/graphics/Rect;
...
.method public P()I
    ...
    iget v0, p0, Landroidx/appcompat/widget/w$e;->S:I
...
.method Q(Landroid/view/View;)Z
    ...
    invoke-static {p1}, Lx/x;->v(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_10

    iget-object v0, p0, Landroidx/appcompat/widget/w$e;->R:Landroid/graphics/Rect;
...
.method public h(Ljava/lang/CharSequence;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/w$e;->P:Ljava/lang/CharSequence;
...
.method public k(I)V
    ...
    iput p1, p0, Landroidx/appcompat/widget/w$e;->S:I
...
.method public m(II)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/w$e;->T:Landroidx/appcompat/widget/w;
...
.method public o()Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/w$e;->P:Ljava/lang/CharSequence;
...
.method public p(Landroid/widget/ListAdapter;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/w$e;->Q:Landroid/widget/ListAdapter;
