...
.method constructor <init>(Landroidx/vectordrawable/graphics/drawable/g$c;)V
    ...
    iget-object v0, p1, Landroidx/vectordrawable/graphics/drawable/g$c;->f:Lp/b;

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/g$c;->f:Lp/b;
    ...
    iget-object v0, p1, Landroidx/vectordrawable/graphics/drawable/g$c;->h:Lp/b;

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/g$c;->h:Lp/b;
...
.method private h(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;)V
    ...
    invoke-static {p2, v0}, Lp/i;->j(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {v0}, Lq/c;->d(Ljava/lang/String;)[Lq/c$b;

    move-result-object v0

    iput-object v0, p0, Landroidx/vectordrawable/graphics/drawable/g$f;->a:[Lq/c$b;
    ...
    invoke-static/range {v1 .. v6}, Lp/i;->e(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;Ljava/lang/String;II)Lp/b;
    ...
    invoke-static {p1, p2, v2, v0, v1}, Lp/i;->f(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    invoke-static {p1, p2, v1, v0, v2}, Lp/i;->g(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
    ...
    iput-object p3, p0, Landroidx/vectordrawable/graphics/drawable/g$c;->f:Lp/b;
    ...
    invoke-static {p1, p2, v1, p3, v0}, Lp/i;->f(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    invoke-static {p1, p2, v1, p3, v0}, Lp/i;->g(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;II)I
...
.method public a()Z
    ...
    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/g$c;->h:Lp/b;

    invoke-virtual {v0}, Lp/b;->i()Z

    move-result v0

    if-nez v0, :cond_13

    iget-object v0, p0, Landroidx/vectordrawable/graphics/drawable/g$c;->f:Lp/b;
...
.method public b([I)Z
    ...
    iget-object v1, p0, Landroidx/vectordrawable/graphics/drawable/g$c;->f:Lp/b;

    invoke-virtual {v1, p1}, Lp/b;->j([I)Z
...
.method public g(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-static {p1, p3, p2, v0}, Lp/i;->k(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
...
.method setFillColor(I)V
    ...
    invoke-virtual {v0, p1}, Lp/b;->k(I)V
