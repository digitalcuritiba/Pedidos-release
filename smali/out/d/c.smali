...
.method private d(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v1}, Ld/c$b;->b(Landroid/graphics/drawable/Drawable$Callback;)Ld/c$b;
    ...
    :try_start_18
    iget-object v0, p0, Ld/c;->a:Ld/c$c;

    iget v0, v0, Ld/c$c;->A:I
    ...
    iget-boolean v1, v0, Ld/c$c;->E:Z

    if-eqz v1, :cond_33

    iget-object v0, v0, Ld/c$c;->D:Landroid/graphics/ColorFilter;
    ...
    :cond_33
    iget-boolean v1, v0, Ld/c$c;->H:Z

    if-eqz v1, :cond_3c

    iget-object v0, v0, Ld/c$c;->F:Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Ld/c$c;->G:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, p0, Ld/c;->b:Landroid/graphics/Rect;
    ...
    invoke-virtual {v0}, Ld/c$b;->a()Landroid/graphics/drawable/Drawable$Callback;
    ...
    invoke-virtual {v1}, Ld/c$b;->a()Landroid/graphics/drawable/Drawable$Callback;
...
.method private e()Z
    ...
    invoke-virtual {p0}, Ld/c;->isAutoMirrored()Z
...
.method a(Z)V
    ...
    iget-object v3, p0, Ld/c;->c:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v9, p0, Ld/c;->a:Ld/c$c;
    ...
    :goto_39
    iget-object v9, p0, Ld/c;->d:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v4, p0, Ld/c;->a:Ld/c$c;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Ld/c;->c:Landroid/graphics/drawable/Drawable;
...
.method g(I)Z
    ...
    iput-object v0, p0, Ld/c;->c:Landroid/graphics/drawable/Drawable;

    iput p1, p0, Ld/c;->m:I

    if-eqz v0, :cond_5a

    iget-object p1, p0, Ld/c;->a:Ld/c$c;
    ...
    :cond_51
    invoke-direct {p0, v0}, Ld/c;->d(Landroid/graphics/drawable/Drawable;)V

    goto :goto_5a

    :cond_55
    iput-object v4, p0, Ld/c;->c:Landroid/graphics/drawable/Drawable;
...
.method public getChangingConfigurations()I
    ...
    iget-object v1, p0, Ld/c;->a:Ld/c$c;
...
.method public getPadding(Landroid/graphics/Rect;)Z
    ...
    invoke-virtual {v0}, Ld/c$c;->l()Landroid/graphics/Rect;
...
.method h(Ld/c$c;)V
    ...
    iput-object p1, p0, Ld/c;->a:Ld/c$c;
    ...
    iput-object p1, p0, Ld/c;->c:Landroid/graphics/drawable/Drawable;

    if-eqz p1, :cond_11

    invoke-direct {p0, p1}, Ld/c;->d(Landroid/graphics/drawable/Drawable;)V

    :cond_11
    const/4 p1, 0x0

    iput-object p1, p0, Ld/c;->d:Landroid/graphics/drawable/Drawable;
...
.method final i(Landroid/content/res/Resources;)V
    ...
    invoke-virtual {v0, p1}, Ld/c$c;->y(Landroid/content/res/Resources;)V
...
.method public jumpToCurrentState()V
    ...
    :goto_e
    iget-object v2, p0, Ld/c;->c:Landroid/graphics/drawable/Drawable;
...
.method public mutate()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0}, Ld/c$c;->r()V

    invoke-virtual {p0, v0}, Ld/c;->h(Ld/c$c;)V
...
.method public onLayoutDirectionChanged(I)Z
    ...
    invoke-virtual {v0, p1, v1}, Ld/c$c;->w(II)Z
...
.method public setHotspotBounds(IIII)V
    ...
    iput-object v0, p0, Ld/c;->b:Landroid/graphics/Rect;
...
.method public setVisible(ZZ)Z
    ...
    :cond_b
    iget-object v1, p0, Ld/c;->c:Landroid/graphics/drawable/Drawable;
