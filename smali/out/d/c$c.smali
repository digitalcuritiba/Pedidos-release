...
# direct methods
.method constructor <init>(Ld/c$c;Ld/c;Landroid/content/res/Resources;)V
    .registers 6
    ...
    iput-boolean v0, p0, Ld/c$c;->i:Z

    iput-boolean v0, p0, Ld/c$c;->l:Z

    const/4 v1, 0x1

    iput-boolean v1, p0, Ld/c$c;->x:Z

    iput v0, p0, Ld/c$c;->A:I

    iput v0, p0, Ld/c$c;->B:I
    ...
    :goto_27
    invoke-static {p3, p2}, Ld/c;->f(Landroid/content/res/Resources;I)I

    move-result p2

    iput p2, p0, Ld/c$c;->c:I

    if-eqz p1, :cond_ea

    iget p3, p1, Ld/c$c;->d:I

    iput p3, p0, Ld/c$c;->d:I

    iget p3, p1, Ld/c$c;->e:I

    iput p3, p0, Ld/c$c;->e:I

    iput-boolean v1, p0, Ld/c$c;->v:Z

    iput-boolean v1, p0, Ld/c$c;->w:Z

    iget-boolean p3, p1, Ld/c$c;->i:Z

    iput-boolean p3, p0, Ld/c$c;->i:Z

    iget-boolean p3, p1, Ld/c$c;->l:Z

    iput-boolean p3, p0, Ld/c$c;->l:Z

    iget-boolean p3, p1, Ld/c$c;->x:Z

    iput-boolean p3, p0, Ld/c$c;->x:Z

    iget-boolean p3, p1, Ld/c$c;->y:Z

    iput-boolean p3, p0, Ld/c$c;->y:Z

    iget p3, p1, Ld/c$c;->z:I

    iput p3, p0, Ld/c$c;->z:I

    iget p3, p1, Ld/c$c;->A:I

    iput p3, p0, Ld/c$c;->A:I

    iget p3, p1, Ld/c$c;->B:I

    iput p3, p0, Ld/c$c;->B:I

    iget-boolean p3, p1, Ld/c$c;->C:Z

    iput-boolean p3, p0, Ld/c$c;->C:Z

    iget-object p3, p1, Ld/c$c;->D:Landroid/graphics/ColorFilter;

    iput-object p3, p0, Ld/c$c;->D:Landroid/graphics/ColorFilter;

    iget-boolean p3, p1, Ld/c$c;->E:Z

    iput-boolean p3, p0, Ld/c$c;->E:Z

    iget-object p3, p1, Ld/c$c;->F:Landroid/content/res/ColorStateList;

    iput-object p3, p0, Ld/c$c;->F:Landroid/content/res/ColorStateList;

    iget-object p3, p1, Ld/c$c;->G:Landroid/graphics/PorterDuff$Mode;

    iput-object p3, p0, Ld/c$c;->G:Landroid/graphics/PorterDuff$Mode;

    iget-boolean p3, p1, Ld/c$c;->H:Z

    iput-boolean p3, p0, Ld/c$c;->H:Z

    iget-boolean p3, p1, Ld/c$c;->I:Z

    iput-boolean p3, p0, Ld/c$c;->I:Z

    iget p3, p1, Ld/c$c;->c:I
    ...
    iget-object v1, p0, Ld/c$c;->f:Landroid/util/SparseArray;
...
.method private e()V
    ...
    invoke-direct {p0, v3}, Ld/c$c;->s(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method private s(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    iget v0, p0, Ld/c$c;->z:I

    invoke-static {p1, v0}, Ld/b;->a(Landroid/graphics/drawable/Drawable;I)Z
    ...
    iget-object v0, p0, Ld/c$c;->a:Ld/c;
...
.method public final a(Landroid/graphics/drawable/Drawable;)I
    ...
    invoke-virtual {p0, v0, v1}, Ld/c$c;->o(II)V
...
.method final b(Landroid/content/res/Resources$Theme;)V
    ...
    invoke-virtual {p0, p1}, Ld/c$c;->y(Landroid/content/res/Resources;)V
...
.method public final g(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v2}, Ld/c$c;->s(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public final i()I
    ...
    iget-boolean v0, p0, Ld/c$c;->m:Z

    if-nez v0, :cond_7

    invoke-virtual {p0}, Ld/c$c;->d()V

    :cond_7
    iget v0, p0, Ld/c$c;->o:I
...
.method p()V
    ...
    iput-boolean v0, p0, Ld/c$c;->r:Z

    iput-boolean v0, p0, Ld/c$c;->t:Z
...
.method final w(II)Z
    ...
    invoke-static {v5, p1}, Ld/b;->a(Landroid/graphics/drawable/Drawable;I)Z
...
.method final y(Landroid/content/res/Resources;)V
    ...
    invoke-static {p1, v0}, Ld/c;->f(Landroid/content/res/Resources;I)I
