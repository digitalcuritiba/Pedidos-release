...
.method private h()I
    ...
    invoke-static {v1}, Lio/grpc/internal/s0;->c(Lio/grpc/internal/s0;)I
    ...
    invoke-static {v0}, Lio/grpc/internal/s0;->j(Lio/grpc/internal/s0;)[B

    move-result-object v0

    iget-object v2, p0, Lio/grpc/internal/s0$b;->a:Lio/grpc/internal/s0;

    invoke-static {v2}, Lio/grpc/internal/s0;->c(Lio/grpc/internal/s0;)I
    ...
    invoke-static {v2, v1}, Lio/grpc/internal/s0;->d(Lio/grpc/internal/s0;I)I
    ...
    invoke-static {v0}, Lio/grpc/internal/s0;->n(Lio/grpc/internal/s0;)Lio/grpc/internal/u;
    ...
    invoke-static {v2}, Lio/grpc/internal/s0;->r(Lio/grpc/internal/s0;)Ljava/util/zip/CRC32;
    ...
    invoke-static {v2, v1}, Lio/grpc/internal/s0;->t(Lio/grpc/internal/s0;I)I
...
.method private k()I
    ...
    invoke-static {v1}, Lio/grpc/internal/s0;->n(Lio/grpc/internal/s0;)Lio/grpc/internal/u;
...
.method private l(I)V
    ...
    invoke-static {v1}, Lio/grpc/internal/s0;->r(Lio/grpc/internal/s0;)Ljava/util/zip/CRC32;

    move-result-object v1

    iget-object v2, p0, Lio/grpc/internal/s0$b;->a:Lio/grpc/internal/s0;

    invoke-static {v2}, Lio/grpc/internal/s0;->j(Lio/grpc/internal/s0;)[B

    move-result-object v2

    iget-object v3, p0, Lio/grpc/internal/s0$b;->a:Lio/grpc/internal/s0;

    invoke-static {v3}, Lio/grpc/internal/s0;->c(Lio/grpc/internal/s0;)I
    ...
    invoke-static {v1, v0}, Lio/grpc/internal/s0;->d(Lio/grpc/internal/s0;I)I
    ...
    invoke-static {v6}, Lio/grpc/internal/s0;->n(Lio/grpc/internal/s0;)Lio/grpc/internal/u;

    move-result-object v6

    invoke-virtual {v6, v2, v3, v5}, Lio/grpc/internal/u;->f0([BII)V

    iget-object v6, p0, Lio/grpc/internal/s0$b;->a:Lio/grpc/internal/s0;

    invoke-static {v6}, Lio/grpc/internal/s0;->r(Lio/grpc/internal/s0;)Ljava/util/zip/CRC32;
    ...
    invoke-static {v0, p1}, Lio/grpc/internal/s0;->t(Lio/grpc/internal/s0;I)I
