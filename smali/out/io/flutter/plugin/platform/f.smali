...
.field private d:Lz4/j$j;

.field private e:I

.field final f:Lz4/j$h;


# direct methods
.method public constructor <init>(Landroid/app/Activity;Lz4/j;Lio/flutter/plugin/platform/f$d;)V
    .registers 5
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/f;->f:Lz4/j$h;

    iput-object p1, p0, Lio/flutter/plugin/platform/f;->a:Landroid/app/Activity;

    iput-object p2, p0, Lio/flutter/plugin/platform/f;->b:Lz4/j;

    invoke-virtual {p2, v0}, Lz4/j;->l(Lz4/j$h;)V
...
.method private B(Lz4/j$j;)V
    ...
    new-instance v2, Lx/w0;

    invoke-direct {v2, v0, v1}, Lx/w0;-><init>(Landroid/view/Window;Landroid/view/View;)V
    ...
    iget-object v3, p1, Lz4/j$j;->b:Lz4/j$d;
    ...
    :cond_37
    invoke-virtual {v2, v4}, Lx/w0;->b(Z)V

    goto :goto_3e

    :cond_3b
    invoke-virtual {v2, v6}, Lx/w0;->b(Z)V

    :cond_3e
    :goto_3e
    iget-object v3, p1, Lz4/j$j;->a:Ljava/lang/Integer;
    ...
    :cond_49
    iget-object v3, p1, Lz4/j$j;->c:Ljava/lang/Boolean;
    ...
    iget-object v3, p1, Lz4/j$j;->e:Lz4/j$d;
    ...
    :cond_6d
    invoke-virtual {v2, v4}, Lx/w0;->a(Z)V

    goto :goto_74

    :cond_71
    invoke-virtual {v2, v6}, Lx/w0;->a(Z)V

    :cond_74
    :goto_74
    iget-object v2, p1, Lz4/j$j;->d:Ljava/lang/Integer;
    ...
    :cond_7f
    iget-object v2, p1, Lz4/j$j;->f:Ljava/lang/Integer;
    ...
    :cond_8e
    iget-object v2, p1, Lz4/j$j;->g:Ljava/lang/Boolean;
    ...
    :cond_9b
    iput-object p1, p0, Lio/flutter/plugin/platform/f;->d:Lz4/j$j;

    return-void
.end method

.method static synthetic a(Lio/flutter/plugin/platform/f;Lz4/j$i;)V
    .registers 2

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/f;->r(Lz4/j$i;)V
...
.method static synthetic c(Lio/flutter/plugin/platform/f;Lz4/j$e;)Ljava/lang/CharSequence;
    .registers 2

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/f;->q(Lz4/j$e;)Ljava/lang/CharSequence;
...
.method static synthetic f(Lio/flutter/plugin/platform/f;)Lz4/j;
    .registers 1

    iget-object p0, p0, Lio/flutter/plugin/platform/f;->b:Lz4/j;

    return-object p0
.end method

.method static synthetic g(Lio/flutter/plugin/platform/f;Lz4/j$c;)V
    .registers 2

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/f;->w(Lz4/j$c;)V
...
.method static synthetic i(Lio/flutter/plugin/platform/f;Lz4/j$k;)V
    .registers 2

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/f;->y(Lz4/j$k;)V
...
.method static synthetic l(Lio/flutter/plugin/platform/f;Lz4/j$j;)V
    .registers 2

    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/f;->B(Lz4/j$j;)V
...
.method private q(Lz4/j$e;)Ljava/lang/CharSequence;
    .registers 6
    ...
    sget-object v1, Lz4/j$e;->b:Lz4/j$e;
    ...
    invoke-static {v0, v1, p1}, Ln4/b;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    return-object v2
.end method

.method private r(Lz4/j$i;)V
    .registers 3

    sget-object v0, Lz4/j$i;->b:Lz4/j$i;
...
.method private w(Lz4/j$c;)V
    ...
    iget-object v4, p1, Lz4/j$c;->b:Ljava/lang/String;

    const/4 v5, 0x0

    iget v6, p1, Lz4/j$c;->a:I
    ...
    iget-object v1, p1, Lz4/j$c;->b:Ljava/lang/String;

    const/4 v2, 0x0

    iget p1, p1, Lz4/j$c;->a:I
...
.method private y(Lz4/j$k;)V
    .registers 3

    sget-object v0, Lz4/j$k;->b:Lz4/j$k;
    ...
    :cond_7
    sget-object v0, Lz4/j$k;->c:Lz4/j$k;
    ...
    :cond_e
    sget-object v0, Lz4/j$k;->d:Lz4/j$k;
    ...
    :cond_15
    sget-object v0, Lz4/j$k;->e:Lz4/j$k;
...
.method public C()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/f;->d:Lz4/j$j;

    if-eqz v0, :cond_16

    invoke-direct {p0, v0}, Lio/flutter/plugin/platform/f;->B(Lz4/j$j;)V
...
.method public p()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/f;->b:Lz4/j;

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lz4/j;->l(Lz4/j$h;)V
