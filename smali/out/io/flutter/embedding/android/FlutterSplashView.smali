...
# static fields
.field private static p:Ljava/lang/String; = "FlutterSplashView"


# instance fields
.field private a:Lio/flutter/embedding/android/e0;
...
.field private final m:Lio/flutter/embedding/android/r$f;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->m:Lio/flutter/embedding/android/r$f;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->n:Ly4/b;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->o:Ljava/lang/Runnable;
...
.method static synthetic a(Lio/flutter/embedding/android/FlutterSplashView;)Lio/flutter/embedding/android/r;
    .registers 1

    iget-object p0, p0, Lio/flutter/embedding/android/FlutterSplashView;->b:Lio/flutter/embedding/android/r;

    return-object p0
.end method

.method static synthetic b(Lio/flutter/embedding/android/FlutterSplashView;)Lio/flutter/embedding/android/e0;
    .registers 1

    iget-object p0, p0, Lio/flutter/embedding/android/FlutterSplashView;->a:Lio/flutter/embedding/android/e0;
...
.method static synthetic e(Lio/flutter/embedding/android/FlutterSplashView;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->l:Ljava/lang/String;
...
.method private h()Z
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->b:Lio/flutter/embedding/android/r;

    if-eqz v0, :cond_3c

    invoke-virtual {v0}, Lio/flutter/embedding/android/r;->x()Z
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/android/r;->getAttachedFlutterEngine()Lio/flutter/embedding/engine/a;
    ...
    invoke-virtual {v0}, Lo4/a;->k()Ljava/lang/String;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterSplashView;->l:Ljava/lang/String;
...
.method private i()Z
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/android/r;->v()Z
...
.method private j()Z
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->a:Lio/flutter/embedding/android/e0;

    if-eqz v0, :cond_1c

    invoke-interface {v0}, Lio/flutter/embedding/android/e0;->b()Z
...
.method private k()V
    ...
    sget-object v0, Lio/flutter/embedding/android/FlutterSplashView;->p:Ljava/lang/String;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterSplashView;->o:Ljava/lang/Runnable;

    invoke-interface {v0, v1}, Lio/flutter/embedding/android/e0;->a(Ljava/lang/Runnable;)V
...
# virtual methods
.method public g(Lio/flutter/embedding/android/r;Lio/flutter/embedding/android/e0;)V
    .registers 5
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterSplashView;->n:Ly4/b;
    ...
    :cond_15
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->b:Lio/flutter/embedding/android/r;

    invoke-virtual {p0, p1}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    iput-object p2, p0, Lio/flutter/embedding/android/FlutterSplashView;->a:Lio/flutter/embedding/android/e0;
    ...
    invoke-interface {p2, v0, v1}, Lio/flutter/embedding/android/e0;->c(Landroid/content/Context;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iget-object p2, p0, Lio/flutter/embedding/android/FlutterSplashView;->n:Ly4/b;

    invoke-virtual {p1, p2}, Lio/flutter/embedding/android/r;->m(Ly4/b;)V
    ...
    sget-object p1, Lio/flutter/embedding/android/FlutterSplashView;->p:Ljava/lang/String;
    ...
    invoke-interface {p2, p1, v0}, Lio/flutter/embedding/android/e0;->c(Landroid/content/Context;Landroid/os/Bundle;)Landroid/view/View;
    ...
    :cond_60
    invoke-virtual {p1}, Lio/flutter/embedding/android/r;->x()Z

    move-result p2

    if-nez p2, :cond_72

    sget-object p2, Lio/flutter/embedding/android/FlutterSplashView;->p:Ljava/lang/String;

    const-string v0, "FlutterView is not yet attached to a FlutterEngine. Showing nothing until a FlutterEngine is attached."

    invoke-static {p2, v0}, Ln4/b;->f(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p2, p0, Lio/flutter/embedding/android/FlutterSplashView;->m:Lio/flutter/embedding/android/r$f;

    invoke-virtual {p1, p2}, Lio/flutter/embedding/android/r;->l(Lio/flutter/embedding/android/r$f;)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->l:Ljava/lang/String;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->l:Ljava/lang/String;
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/e0;->d()Landroid/os/Bundle;
