...
.field private deferredComponentManager:Lp4/a;
...
.field private localizationPlugin:Lb5/b;

.field private final mainLooper:Landroid/os/Looper;

.field private nativeShellHolderId:Ljava/lang/Long;

.field private platformMessageHandler:Lo4/f;

.field private platformViewsController:Lio/flutter/plugin/platform/u;
...
.method public static decodeImage(Ljava/nio/ByteBuffer;J)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p2, p0}, Ln4/b;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private handlePlatformMessageResponse(ILjava/nio/ByteBuffer;)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lo4/f;

    if-eqz v0, :cond_7

    invoke-interface {v0, p1, p2}, Lo4/f;->e(ILjava/nio/ByteBuffer;)V
...
.method public addIsDisplayingFlutterUiListener(Ly4/b;)V
    .registers 3
...
.method public computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lb5/b;
    ...
    :cond_47
    iget-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lb5/b;

    invoke-virtual {p1, v0}, Lb5/b;->c(Ljava/util/List;)Ljava/util/Locale;
...
.method public createOverlaySurface()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Lio/flutter/plugin/platform/u;

    if-eqz v0, :cond_c

    invoke-virtual {v0}, Lio/flutter/plugin/platform/u;->L()Lio/flutter/embedding/engine/FlutterOverlaySurface;
...
.method public dispatchEmptyPlatformMessage(Ljava/lang/String;I)V
    ...
    invoke-static {p2, p1}, Ln4/b;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method public dispatchSemanticsAction(ILio/flutter/view/g$g;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0, p3}, La5/r;->a(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :goto_12
    iget p2, p2, Lio/flutter/view/g$g;->a:I
...
.method public handlePlatformMessage(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
    ...
    invoke-interface/range {v0 .. v5}, Lo4/f;->f(Ljava/lang/String;Ljava/nio/ByteBuffer;IJ)V
...
.method public invokePlatformMessageEmptyResponseCallback(I)V
    ...
    invoke-static {v0, p1}, Ln4/b;->g(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_2f
...
.method public onDisplayOverlaySurface(IIIII)V
    ...
    invoke-virtual/range {v0 .. v5}, Lio/flutter/plugin/platform/u;->j0(IIIII)V
...
.method public onDisplayPlatformView(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    iget-object v1, v0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Lio/flutter/plugin/platform/u;
    ...
    invoke-virtual/range {v1 .. v9}, Lio/flutter/plugin/platform/u;->k0(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
...
.method public onEndFrame()V
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/u;->l0()V
...
.method public removeIsDisplayingFlutterUiListener(Ly4/b;)V
    .registers 3
...
.method public requestDartDeferredLibrary(I)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Lp4/a;

    if-eqz v0, :cond_9

    const/4 v1, 0x0

    invoke-interface {v0, p1, v1}, Lp4/a;->d(ILjava/lang/String;)V
...
.method public setDeferredComponentManager(Lp4/a;)V
    .registers 2

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->deferredComponentManager:Lp4/a;

    if-eqz p1, :cond_a

    invoke-interface {p1, p0}, Lp4/a;->c(Lio/flutter/embedding/engine/FlutterJNI;)V

    :cond_a
    return-void
.end method

.method public setLocalizationPlugin(Lb5/b;)V
    .registers 2

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lb5/b;

    return-void
.end method

.method public setPlatformMessageHandler(Lo4/f;)V
    .registers 2

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformMessageHandler:Lo4/f;

    return-void
.end method

.method public setPlatformViewsController(Lio/flutter/plugin/platform/u;)V
    .registers 2

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Lio/flutter/plugin/platform/u;
...
.method public spawn(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/List;)Lio/flutter/embedding/engine/FlutterJNI;
    ...
    invoke-static {p2, p3}, Lm5/c;->a(ZLjava/lang/Object;)V
