...
.method public constructor <init>(Landroid/content/Context;[Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Lq4/d;->j(Landroid/content/Context;)V

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    move-result-object p1

    invoke-virtual {v0, p1, p2}, Lq4/d;->e(Landroid/content/Context;[Ljava/lang/String;)V
...
.method public a(Lio/flutter/embedding/engine/d$b;)Lio/flutter/embedding/engine/a;
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/d$b;->c()Lo4/a$b;
    ...
    invoke-virtual {p1}, Lio/flutter/embedding/engine/d$b;->f()Lio/flutter/plugin/platform/u;
    ...
    invoke-static {}, Lo4/a$b;->a()Lo4/a$b;
    ...
    invoke-virtual {p0, v1, v5, v6, v7}, Lio/flutter/embedding/engine/d;->b(Landroid/content/Context;Lio/flutter/plugin/platform/u;ZZ)Lio/flutter/embedding/engine/a;

    move-result-object p1

    if-eqz v3, :cond_43

    invoke-virtual {p1}, Lio/flutter/embedding/engine/a;->n()Lz4/i;

    move-result-object v0

    invoke-virtual {v0, v3}, Lz4/i;->c(Ljava/lang/String;)V

    :cond_43
    invoke-virtual {p1}, Lio/flutter/embedding/engine/a;->j()Lo4/a;

    move-result-object v0

    invoke-virtual {v0, v2, v4}, Lo4/a;->j(Lo4/a$b;Ljava/util/List;)V
    ...
    invoke-virtual/range {v0 .. v7}, Lio/flutter/embedding/engine/a;->y(Landroid/content/Context;Lo4/a$b;Ljava/lang/String;Ljava/util/List;Lio/flutter/plugin/platform/u;ZZ)Lio/flutter/embedding/engine/a;
...
.method b(Landroid/content/Context;Lio/flutter/plugin/platform/u;ZZ)Lio/flutter/embedding/engine/a;
    .registers 15
