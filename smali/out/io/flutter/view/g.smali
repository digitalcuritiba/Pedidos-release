...
.field private final e:Lio/flutter/plugin/platform/o;
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lio/flutter/view/g$g;->e:Lio/flutter/view/g$g;

    iget v0, v0, Lio/flutter/view/g$g;->a:I

    sget-object v1, Lio/flutter/view/g$g;->d:Lio/flutter/view/g$g;

    iget v1, v1, Lio/flutter/view/g$g;->a:I
    ...
    sget-object v0, Lio/flutter/view/g$i;->b:Lio/flutter/view/g$i;

    iget v0, v0, Lio/flutter/view/g$i;->a:I

    sget-object v1, Lio/flutter/view/g$i;->c:Lio/flutter/view/g$i;

    iget v1, v1, Lio/flutter/view/g$i;->a:I

    or-int/2addr v0, v1

    sget-object v1, Lio/flutter/view/g$i;->d:Lio/flutter/view/g$i;
    ...
    sget-object v1, Lio/flutter/view/g$i;->o:Lio/flutter/view/g$i;

    iget v1, v1, Lio/flutter/view/g$i;->a:I

    or-int/2addr v0, v1

    sget-object v1, Lio/flutter/view/g$i;->p:Lio/flutter/view/g$i;

    iget v1, v1, Lio/flutter/view/g$i;->a:I

    or-int/2addr v0, v1

    sget-object v1, Lio/flutter/view/g$i;->x:Lio/flutter/view/g$i;

    iget v1, v1, Lio/flutter/view/g$i;->a:I

    or-int/2addr v0, v1

    sget-object v1, Lio/flutter/view/g$i;->y:Lio/flutter/view/g$i;
    ...
    sget-object v1, Lio/flutter/view/g$i;->E:Lio/flutter/view/g$i;
...
.method public constructor <init>(Landroid/view/View;Lz4/a;Landroid/view/accessibility/AccessibilityManager;Landroid/content/ContentResolver;Lio/flutter/plugin/platform/o;)V
    .registers 13
    ...
    invoke-direct/range {v0 .. v6}, Lio/flutter/view/g;-><init>(Landroid/view/View;Lz4/a;Landroid/view/accessibility/AccessibilityManager;Landroid/content/ContentResolver;Lio/flutter/view/AccessibilityViewEmbedder;Lio/flutter/plugin/platform/o;)V

    return-void
.end method

.method public constructor <init>(Landroid/view/View;Lz4/a;Landroid/view/accessibility/AccessibilityManager;Landroid/content/ContentResolver;Lio/flutter/view/AccessibilityViewEmbedder;Lio/flutter/plugin/platform/o;)V
    .registers 11
    ...
    iput-object v1, p0, Lio/flutter/view/g;->v:Lz4/a$b;
    ...
    iput-object p2, p0, Lio/flutter/view/g;->b:Lz4/a;
    ...
    iput-object p6, p0, Lio/flutter/view/g;->e:Lio/flutter/plugin/platform/o;
    ...
    new-instance p2, Lio/flutter/view/g$d;

    invoke-direct {p2, p0, p3}, Lio/flutter/view/g$d;-><init>(Lio/flutter/view/g;Landroid/view/accessibility/AccessibilityManager;)V

    iput-object p2, p0, Lio/flutter/view/g;->x:Landroid/view/accessibility/AccessibilityManager$TouchExplorationStateChangeListener;
    ...
    invoke-direct {p0}, Lio/flutter/view/g;->X()V

    :cond_7d
    invoke-interface {p6, p0}, Lio/flutter/plugin/platform/o;->a(Lio/flutter/view/g;)V
...
.method private B(FFZ)V
    ...
    invoke-static {v0, v1, p3}, Lio/flutter/view/g$l;->J(Lio/flutter/view/g$l;[FZ)Lio/flutter/view/g$l;
    ...
    invoke-virtual {p0, p2, p3}, Lio/flutter/view/g;->R(II)V
...
.method private static synthetic E(Lio/flutter/view/g$l;Lio/flutter/view/g$l;)Z
    .registers 2
...
.method private static synthetic F(Lio/flutter/view/g$l;)Z
    .registers 2

    sget-object v0, Lio/flutter/view/g$i;->z:Lio/flutter/view/g$i;

    invoke-static {p0, v0}, Lio/flutter/view/g$l;->h(Lio/flutter/view/g$l;Lio/flutter/view/g$i;)Z
...
.method private H(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    invoke-virtual {p0, p2}, Lio/flutter/view/g;->G(I)Landroid/view/accessibility/AccessibilityEvent;
...
.method private L()V
    ...
    invoke-virtual {p0, v0, v1}, Lio/flutter/view/g;->R(II)V
...
.method private M(Lio/flutter/view/g$l;)V
    .registers 5

    invoke-static {p1}, Lio/flutter/view/g$l;->d0(Lio/flutter/view/g$l;)Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lio/flutter/view/g;->V(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1, v1}, Lio/flutter/view/g;->H(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    invoke-direct {p0, p1}, Lio/flutter/view/g;->S(Landroid/view/accessibility/AccessibilityEvent;)V

    :goto_26
    return-void
.end method

.method private N(Lio/flutter/view/g$l;ILandroid/os/Bundle;Z)Z
    .registers 9
    ...
    invoke-static {p1}, Lio/flutter/view/g$l;->i(Lio/flutter/view/g$l;)I

    move-result v1

    invoke-static {p1}, Lio/flutter/view/g$l;->k(Lio/flutter/view/g$l;)I

    move-result v2

    invoke-direct {p0, p1, v0, p4, p3}, Lio/flutter/view/g;->P(Lio/flutter/view/g$l;IZZ)V
    ...
    :cond_23
    invoke-static {p1}, Lio/flutter/view/g$l;->q(Lio/flutter/view/g$l;)Ljava/lang/String;
    ...
    invoke-direct {p0, v2, v3}, Lio/flutter/view/g;->H(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    invoke-direct {p0, v2}, Lio/flutter/view/g;->S(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-static {p1, v0}, Lio/flutter/view/g$l;->o(Lio/flutter/view/g$l;Lio/flutter/view/g$g;)Z

    move-result v2

    if-eqz v2, :cond_80

    iget-object p1, p0, Lio/flutter/view/g;->b:Lz4/a;

    invoke-static {p3}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object p3

    invoke-virtual {p1, p2, v0, p3}, Lz4/a;->c(ILio/flutter/view/g$g;Ljava/lang/Object;)V
    ...
    sget-object p4, Lio/flutter/view/g$g;->B:Lio/flutter/view/g$g;

    invoke-static {p1, p4}, Lio/flutter/view/g$l;->o(Lio/flutter/view/g$l;Lio/flutter/view/g$g;)Z
    ...
    invoke-virtual {p1, p2, p4, p3}, Lz4/a;->c(ILio/flutter/view/g$g;Ljava/lang/Object;)V
    ...
    sget-object p4, Lio/flutter/view/g$g;->r:Lio/flutter/view/g$g;
...
.method private O(Lio/flutter/view/g$l;ILandroid/os/Bundle;)Z
    .registers 6
    ...
    :goto_11
    iget-object v0, p0, Lio/flutter/view/g;->b:Lz4/a;

    sget-object v1, Lio/flutter/view/g$g;->C:Lio/flutter/view/g$g;

    invoke-virtual {v0, p2, v1, p3}, Lz4/a;->c(ILio/flutter/view/g$g;Ljava/lang/Object;)V

    invoke-static {p1, p3}, Lio/flutter/view/g$l;->r(Lio/flutter/view/g$l;Ljava/lang/String;)Ljava/lang/String;

    const/4 p2, 0x0

    invoke-static {p1, p2}, Lio/flutter/view/g$l;->F(Lio/flutter/view/g$l;Ljava/util/List;)Ljava/util/List;
...
.method private P(Lio/flutter/view/g$l;IZZ)V
    .registers 8
    ...
    :goto_2c
    invoke-static {p1, p2}, Lio/flutter/view/g$l;->l(Lio/flutter/view/g$l;I)I

    goto/16 :goto_108

    :cond_31
    invoke-static {p1, v2}, Lio/flutter/view/g$l;->l(Lio/flutter/view/g$l;I)I
    ...
    invoke-static {p1, v0}, Lio/flutter/view/g$l;->m(Lio/flutter/view/g$l;I)I
    ...
    invoke-static {p1, p2}, Lio/flutter/view/g$l;->j(Lio/flutter/view/g$l;I)I
...
.method private U(I)V
    ...
    invoke-direct {p0, p1, v0}, Lio/flutter/view/g;->H(II)Landroid/view/accessibility/AccessibilityEvent;
...
.method private W(Z)V
    ...
    sget-object v0, Lio/flutter/view/g$f;->b:Lio/flutter/view/g$f;

    iget v0, v0, Lio/flutter/view/g$f;->a:I
    ...
    invoke-direct {p0}, Lio/flutter/view/g;->T()V
...
.method private X()V
    ...
    sget-object v1, Lio/flutter/view/g$f;->e:Lio/flutter/view/g$f;

    iget v1, v1, Lio/flutter/view/g$f;->a:I
...
.method private Z(Lio/flutter/view/g$l;)Z
    .registers 4
    ...
    invoke-static {v0, v1}, Lio/flutter/view/g$l;->d(Lio/flutter/view/g$l;Lm5/d;)Z
    ...
    invoke-static {p1, v0}, Lio/flutter/view/g$l;->d(Lio/flutter/view/g$l;Lm5/d;)Z
...
.method public static synthetic a(Lio/flutter/view/g$l;)Z
    ...
    invoke-static {p0}, Lio/flutter/view/g;->F(Lio/flutter/view/g$l;)Z
...
.method public static synthetic b(Lio/flutter/view/g$l;Lio/flutter/view/g$l;)Z
    ...
    invoke-static {p0, p1}, Lio/flutter/view/g;->E(Lio/flutter/view/g$l;Lio/flutter/view/g$l;)Z
...
.method private c0(Lio/flutter/view/g$l;)V
    .registers 8

    const/4 v0, 0x0

    invoke-static {p1, v0}, Lio/flutter/view/g$l;->u(Lio/flutter/view/g$l;Lio/flutter/view/g$l;)Lio/flutter/view/g$l;
    ...
    iget-object v4, p0, Lio/flutter/view/g;->e:Lio/flutter/plugin/platform/o;

    invoke-static {p1}, Lio/flutter/view/g$l;->e(Lio/flutter/view/g$l;)I

    move-result v5

    invoke-interface {v4, v5}, Lio/flutter/plugin/platform/o;->c(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v1, v2}, Lio/flutter/view/g;->R(II)V
    ...
    iget-object v1, p0, Lio/flutter/view/g;->e:Lio/flutter/plugin/platform/o;

    invoke-static {p1}, Lio/flutter/view/g$l;->e(Lio/flutter/view/g$l;)I

    move-result v3

    invoke-interface {v1, v3}, Lio/flutter/plugin/platform/o;->c(I)Landroid/view/View;
...
.method static synthetic i(Lio/flutter/view/g;II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    invoke-direct {p0, p1, p2}, Lio/flutter/view/g;->H(II)Landroid/view/accessibility/AccessibilityEvent;
...
.method static synthetic l(Lio/flutter/view/g;)Lz4/a$b;
    .registers 1

    iget-object p0, p0, Lio/flutter/view/g;->v:Lz4/a$b;

    return-object p0
.end method

.method static synthetic m(Lio/flutter/view/g;)Lz4/a;
    .registers 1

    iget-object p0, p0, Lio/flutter/view/g;->b:Lz4/a;

    return-object p0
.end method

.method static synthetic n(Lio/flutter/view/g;I)Lio/flutter/view/g$l;
    .registers 2
...
.method static synthetic o(Lio/flutter/view/g;I)Lio/flutter/view/g$h;
    .registers 2
...
.method static synthetic p(Lio/flutter/view/g;Z)V
    .registers 2

    invoke-direct {p0, p1}, Lio/flutter/view/g;->W(Z)V
...
.method public J(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {p0, p1, v0}, Lio/flutter/view/g;->K(Landroid/view/MotionEvent;Z)Z
...
.method public K(Landroid/view/MotionEvent;Z)Z
    ...
    invoke-static {v0, v2, p2}, Lio/flutter/view/g$l;->J(Lio/flutter/view/g$l;[FZ)Lio/flutter/view/g$l;
    ...
    invoke-static {p2, p1}, Ln4/b;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public Q()V
    ...
    iget-object v0, p0, Lio/flutter/view/g;->e:Lio/flutter/plugin/platform/o;

    invoke-interface {v0}, Lio/flutter/plugin/platform/o;->d()V

    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lio/flutter/view/g;->Y(Lio/flutter/view/g$k;)V
    ...
    iget-object v1, p0, Lio/flutter/view/g;->b:Lz4/a;

    invoke-virtual {v1, v0}, Lz4/a;->g(Lz4/a$b;)V
...
.method public Y(Lio/flutter/view/g$k;)V
    .registers 2
...
.method b0(Ljava/nio/ByteBuffer;[Ljava/lang/String;[Ljava/nio/ByteBuffer;)V
    ...
    invoke-static {v1, p1, p2, p3}, Lio/flutter/view/g$l;->K(Lio/flutter/view/g$l;Ljava/nio/ByteBuffer;[Ljava/lang/String;[Ljava/nio/ByteBuffer;)V

    sget-object v3, Lio/flutter/view/g$i;->u:Lio/flutter/view/g$i;

    invoke-static {v1, v3}, Lio/flutter/view/g$l;->h(Lio/flutter/view/g$l;Lio/flutter/view/g$i;)Z
    ...
    :cond_20
    sget-object v3, Lio/flutter/view/g$i;->m:Lio/flutter/view/g$i;
    ...
    :cond_2a
    invoke-static {v1}, Lio/flutter/view/g$l;->L(Lio/flutter/view/g$l;)Z
    ...
    iget-object v3, p0, Lio/flutter/view/g;->e:Lio/flutter/plugin/platform/o;

    invoke-static {v1}, Lio/flutter/view/g$l;->e(Lio/flutter/view/g$l;)I

    move-result v4

    invoke-interface {v3, v4}, Lio/flutter/plugin/platform/o;->b(I)Z
    ...
    invoke-interface {v3, v1}, Lio/flutter/plugin/platform/o;->c(I)Landroid/view/View;
    ...
    invoke-static {v4}, Lx/c0;->a(Landroid/view/View;)Landroid/view/WindowInsets;
    ...
    invoke-static {p2, v1}, Lio/flutter/view/g$l;->M(Lio/flutter/view/g$l;Z)Z

    invoke-static {p2, v1}, Lio/flutter/view/g$l;->N(Lio/flutter/view/g$l;Z)Z
    ...
    :cond_b1
    invoke-static {p2, v3, p1, v2}, Lio/flutter/view/g$l;->O(Lio/flutter/view/g$l;[FLjava/util/Set;Z)V

    invoke-static {p2, p3}, Lio/flutter/view/g$l;->P(Lio/flutter/view/g$l;Ljava/util/List;)V
    ...
    invoke-direct {p0, v4}, Lio/flutter/view/g;->M(Lio/flutter/view/g$l;)V
    ...
    invoke-direct {p0, p3}, Lio/flutter/view/g;->c0(Lio/flutter/view/g$l;)V
    ...
    :cond_15a
    invoke-direct {p0, v2}, Lio/flutter/view/g;->U(I)V
    ...
    invoke-static {p2}, Lio/flutter/view/g$l;->Q(Lio/flutter/view/g$l;)Z
    ...
    invoke-direct {p0, p3, v0}, Lio/flutter/view/g;->H(II)Landroid/view/accessibility/AccessibilityEvent;

    move-result-object p3

    invoke-static {p2}, Lio/flutter/view/g$l;->R(Lio/flutter/view/g$l;)F

    move-result v0

    invoke-static {p2}, Lio/flutter/view/g$l;->S(Lio/flutter/view/g$l;)F
    ...
    :goto_1c0
    sget-object v5, Lio/flutter/view/g$g;->l:Lio/flutter/view/g$g;

    invoke-static {p2, v5}, Lio/flutter/view/g$l;->U(Lio/flutter/view/g$l;Lio/flutter/view/g$g;)Z

    move-result v5

    if-nez v5, :cond_1ea

    sget-object v5, Lio/flutter/view/g$g;->m:Lio/flutter/view/g$g;
    ...
    :cond_1d1
    sget-object v5, Lio/flutter/view/g$g;->d:Lio/flutter/view/g$g;
    ...
    sget-object v5, Lio/flutter/view/g$g;->e:Lio/flutter/view/g$g;
    ...
    invoke-static {p2}, Lio/flutter/view/g$l;->V(Lio/flutter/view/g$l;)I

    move-result v0

    invoke-virtual {p3, v0}, Landroid/view/accessibility/AccessibilityRecord;->setFromIndex(I)V

    invoke-static {p2}, Lio/flutter/view/g$l;->W(Lio/flutter/view/g$l;)Ljava/util/List;
    ...
    sget-object v6, Lio/flutter/view/g$i;->u:Lio/flutter/view/g$i;

    invoke-static {v5, v6}, Lio/flutter/view/g$l;->h(Lio/flutter/view/g$l;Lio/flutter/view/g$i;)Z
    ...
    :cond_22f
    invoke-direct {p0, p3}, Lio/flutter/view/g;->S(Landroid/view/accessibility/AccessibilityEvent;)V

    :cond_232
    sget-object p3, Lio/flutter/view/g$i;->w:Lio/flutter/view/g$i;

    invoke-static {p2, p3}, Lio/flutter/view/g$l;->h(Lio/flutter/view/g$l;Lio/flutter/view/g$i;)Z

    move-result p3

    if-eqz p3, :cond_247

    invoke-static {p2}, Lio/flutter/view/g$l;->X(Lio/flutter/view/g$l;)Z
    ...
    invoke-direct {p0, p3}, Lio/flutter/view/g;->U(I)V
    ...
    sget-object p3, Lio/flutter/view/g$i;->d:Lio/flutter/view/g$i;

    invoke-static {p2, p3}, Lio/flutter/view/g$l;->Y(Lio/flutter/view/g$l;Lio/flutter/view/g$i;)Z
    ...
    invoke-static {p2}, Lio/flutter/view/g$l;->Z(Lio/flutter/view/g$l;)Ljava/lang/String;
    ...
    sget-object p3, Lio/flutter/view/g$i;->l:Lio/flutter/view/g$i;
    ...
    :cond_2dc
    invoke-static {p2}, Lio/flutter/view/g$l;->a0(Lio/flutter/view/g$l;)Ljava/lang/String;
    ...
    :goto_2ea
    invoke-static {p2}, Lio/flutter/view/g$l;->q(Lio/flutter/view/g$l;)Ljava/lang/String;
    ...
    :cond_301
    invoke-static {p2}, Lio/flutter/view/g$l;->b0(Lio/flutter/view/g$l;)I

    move-result p3

    invoke-static {p2}, Lio/flutter/view/g$l;->i(Lio/flutter/view/g$l;)I

    move-result v4

    if-ne p3, v4, :cond_315

    invoke-static {p2}, Lio/flutter/view/g$l;->c0(Lio/flutter/view/g$l;)I

    move-result p3

    invoke-static {p2}, Lio/flutter/view/g$l;->k(Lio/flutter/view/g$l;)I
    ...
    invoke-direct {p0, p3, v4}, Lio/flutter/view/g;->H(II)Landroid/view/accessibility/AccessibilityEvent;
...
.method public createAccessibilityNodeInfo(I)Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-direct {p0, v0}, Lio/flutter/view/g;->W(Z)V
    ...
    :cond_30
    iget-object v4, p0, Lio/flutter/view/g;->g:Ljava/util/Map;
    ...
    :cond_40
    invoke-static {v4}, Lio/flutter/view/g$l;->e(Lio/flutter/view/g$l;)I

    move-result v6

    if-eq v6, v2, :cond_6e

    iget-object v6, p0, Lio/flutter/view/g;->e:Lio/flutter/plugin/platform/o;

    invoke-static {v4}, Lio/flutter/view/g$l;->e(Lio/flutter/view/g$l;)I

    move-result v7

    invoke-interface {v6, v7}, Lio/flutter/plugin/platform/o;->b(I)Z

    move-result v6

    if-eqz v6, :cond_6e

    iget-object p1, p0, Lio/flutter/view/g;->e:Lio/flutter/plugin/platform/o;

    invoke-static {v4}, Lio/flutter/view/g$l;->e(Lio/flutter/view/g$l;)I

    move-result v0

    invoke-interface {p1, v0}, Lio/flutter/plugin/platform/o;->c(I)Landroid/view/View;
    ...
    :cond_5f
    invoke-static {v4}, Lio/flutter/view/g$l;->f(Lio/flutter/view/g$l;)Landroid/graphics/Rect;
    ...
    :cond_6e
    iget-object v5, p0, Lio/flutter/view/g;->a:Landroid/view/View;

    invoke-virtual {p0, v5, p1}, Lio/flutter/view/g;->I(Landroid/view/View;I)Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-static {v4}, Lio/flutter/view/g$l;->g(Lio/flutter/view/g$l;)Z
    ...
    :cond_b9
    sget-object v8, Lio/flutter/view/g$i;->l:Lio/flutter/view/g$i;

    invoke-static {v4, v8}, Lio/flutter/view/g$l;->h(Lio/flutter/view/g$l;Lio/flutter/view/g$i;)Z

    move-result v9

    if-eqz v9, :cond_168

    sget-object v9, Lio/flutter/view/g$i;->r:Lio/flutter/view/g$i;

    invoke-static {v4, v9}, Lio/flutter/view/g$l;->h(Lio/flutter/view/g$l;Lio/flutter/view/g$i;)Z

    move-result v9

    invoke-virtual {v5, v9}, Landroid/view/accessibility/AccessibilityNodeInfo;->setPassword(Z)V

    sget-object v9, Lio/flutter/view/g$i;->B:Lio/flutter/view/g$i;
    ...
    invoke-static {v4}, Lio/flutter/view/g$l;->i(Lio/flutter/view/g$l;)I

    move-result v9

    if-eq v9, v2, :cond_f6

    invoke-static {v4}, Lio/flutter/view/g$l;->k(Lio/flutter/view/g$l;)I
    ...
    invoke-static {v4, v9}, Lio/flutter/view/g$l;->o(Lio/flutter/view/g$l;Lio/flutter/view/g$g;)Z
    ...
    :goto_113
    sget-object v11, Lio/flutter/view/g$g;->r:Lio/flutter/view/g$g;

    invoke-static {v4, v11}, Lio/flutter/view/g$l;->o(Lio/flutter/view/g$l;Lio/flutter/view/g$g;)Z
    ...
    :cond_122
    sget-object v11, Lio/flutter/view/g$g;->A:Lio/flutter/view/g$g;
    ...
    :cond_12f
    sget-object v10, Lio/flutter/view/g$g;->B:Lio/flutter/view/g$g;

    invoke-static {v4, v10}, Lio/flutter/view/g$l;->o(Lio/flutter/view/g$l;Lio/flutter/view/g$g;)Z
    ...
    invoke-static {v4}, Lio/flutter/view/g$l;->p(Lio/flutter/view/g$l;)I

    move-result v9

    if-ltz v9, :cond_168

    invoke-static {v4}, Lio/flutter/view/g$l;->q(Lio/flutter/view/g$l;)Ljava/lang/String;
    ...
    :goto_155
    invoke-static {v4}, Lio/flutter/view/g$l;->s(Lio/flutter/view/g$l;)I
    ...
    :cond_175
    sget-object v9, Lio/flutter/view/g$g;->t:Lio/flutter/view/g$g;
    ...
    :cond_182
    sget-object v9, Lio/flutter/view/g$g;->u:Lio/flutter/view/g$g;
    ...
    invoke-static {v4, v1}, Lio/flutter/view/g$l;->o(Lio/flutter/view/g$l;Lio/flutter/view/g$g;)Z
    ...
    invoke-static {v4, v1}, Lio/flutter/view/g$l;->h(Lio/flutter/view/g$l;Lio/flutter/view/g$i;)Z
    ...
    :cond_1ca
    sget-object v1, Lio/flutter/view/g$g;->z:Lio/flutter/view/g$g;
    ...
    :cond_1da
    invoke-static {v4}, Lio/flutter/view/g$l;->t(Lio/flutter/view/g$l;)Lio/flutter/view/g$l;
    ...
    :goto_1f3
    invoke-static {v4}, Lio/flutter/view/g$l;->v(Lio/flutter/view/g$l;)I
    ...
    sget-object v1, Lio/flutter/view/g$g;->b:Lio/flutter/view/g$g;
    ...
    invoke-static {v4}, Lio/flutter/view/g$l;->w(Lio/flutter/view/g$l;)Lio/flutter/view/g$h;
    ...
    invoke-static {v4}, Lio/flutter/view/g$l;->x(Lio/flutter/view/g$l;)Lio/flutter/view/g$h;
    ...
    sget-object v9, Lio/flutter/view/g$g;->l:Lio/flutter/view/g$g;
    ...
    sget-object v9, Lio/flutter/view/g$g;->e:Lio/flutter/view/g$g;
    ...
    :cond_2da
    invoke-direct {p0, v4}, Lio/flutter/view/g;->Z(Lio/flutter/view/g$l;)Z

    move-result v9

    if-eqz v9, :cond_2e9

    invoke-static {v4}, Lio/flutter/view/g$l;->c(Lio/flutter/view/g$l;)I
    ...
    :cond_314
    sget-object v1, Lio/flutter/view/g$g;->e:Lio/flutter/view/g$g;
    ...
    :cond_345
    sget-object v1, Lio/flutter/view/g$g;->o:Lio/flutter/view/g$g;
    ...
    invoke-static {v4}, Lio/flutter/view/g$l;->y(Lio/flutter/view/g$l;)Ljava/lang/CharSequence;
    ...
    invoke-static {v4}, Lio/flutter/view/g$l;->z(Lio/flutter/view/g$l;)Ljava/lang/CharSequence;
    ...
    invoke-static {v4}, Lio/flutter/view/g$l;->A(Lio/flutter/view/g$l;)Ljava/lang/CharSequence;

    move-result-object v1

    if-ge v6, v8, :cond_3a3

    invoke-static {v4}, Lio/flutter/view/g$l;->B(Lio/flutter/view/g$l;)Ljava/lang/String;
    ...
    sget-object v7, Lio/flutter/view/g$i;->x:Lio/flutter/view/g$i;

    invoke-static {v4, v7}, Lio/flutter/view/g$l;->h(Lio/flutter/view/g$l;Lio/flutter/view/g$i;)Z
    ...
    sget-object v0, Lio/flutter/view/g$i;->c:Lio/flutter/view/g$i;

    invoke-static {v4, v0}, Lio/flutter/view/g$l;->h(Lio/flutter/view/g$l;Lio/flutter/view/g$i;)Z

    move-result v0

    invoke-virtual {v5, v0}, Landroid/view/accessibility/AccessibilityNodeInfo;->setChecked(Z)V

    sget-object v0, Lio/flutter/view/g$i;->p:Lio/flutter/view/g$i;
    ...
    sget-object v0, Lio/flutter/view/g$i;->y:Lio/flutter/view/g$i;
    ...
    :cond_3f5
    sget-object v0, Lio/flutter/view/g$i;->d:Lio/flutter/view/g$i;
    ...
    invoke-static {v5, v0}, Ly/e;->a(Landroid/view/accessibility/AccessibilityNodeInfo;Z)V
    ...
    invoke-static {v4}, Lio/flutter/view/g$l;->C(Lio/flutter/view/g$l;)Ljava/util/List;
    ...
    :cond_446
    invoke-static {v4}, Lio/flutter/view/g$l;->D(Lio/flutter/view/g$l;)Ljava/util/List;
    ...
    invoke-static {v0, v1}, Lio/flutter/view/g$l;->h(Lio/flutter/view/g$l;Lio/flutter/view/g$i;)Z
...
.method public performAction(IILandroid/os/Bundle;)Z
    ...
    iget-object p3, p0, Lio/flutter/view/g;->b:Lz4/a;
    ...
    invoke-virtual {p3, p1, v0, p2}, Lz4/a;->c(ILio/flutter/view/g$g;Ljava/lang/Object;)V

    return v5

    :sswitch_4a
    iget-object p2, p0, Lio/flutter/view/g;->b:Lz4/a;

    sget-object p3, Lio/flutter/view/g$g;->p:Lio/flutter/view/g$g;

    invoke-virtual {p2, p1, p3}, Lz4/a;->b(ILio/flutter/view/g$g;)V

    return v5

    :sswitch_52
    invoke-direct {p0, v2, p1, p3}, Lio/flutter/view/g;->O(Lio/flutter/view/g$l;ILandroid/os/Bundle;)Z
    ...
    sget-object p3, Lio/flutter/view/g$g;->z:Lio/flutter/view/g$g;
    ...
    :cond_8d
    invoke-static {v2}, Lio/flutter/view/g$l;->k(Lio/flutter/view/g$l;)I
    ...
    sget-object v0, Lio/flutter/view/g$g;->s:Lio/flutter/view/g$g;
    ...
    invoke-static {p1, p3}, Lio/flutter/view/g$l;->j(Lio/flutter/view/g$l;I)I
    ...
    invoke-static {v2, p2}, Lio/flutter/view/g$l;->o(Lio/flutter/view/g$l;Lio/flutter/view/g$g;)Z
    ...
    invoke-virtual {p3, p1, p2}, Lz4/a;->b(ILio/flutter/view/g$g;)V

    goto :goto_11a

    :cond_f7
    sget-object p2, Lio/flutter/view/g$g;->e:Lio/flutter/view/g$g;
    ...
    :cond_100
    sget-object p2, Lio/flutter/view/g$g;->o:Lio/flutter/view/g$g;
    ...
    invoke-static {v2}, Lio/flutter/view/g$l;->H(Lio/flutter/view/g$l;)Ljava/lang/String;

    move-result-object p3

    invoke-static {v2, p3}, Lio/flutter/view/g$l;->r(Lio/flutter/view/g$l;Ljava/lang/String;)Ljava/lang/String;

    invoke-static {v2}, Lio/flutter/view/g$l;->I(Lio/flutter/view/g$l;)Ljava/util/List;

    move-result-object p3

    invoke-static {v2, p3}, Lio/flutter/view/g$l;->F(Lio/flutter/view/g$l;Ljava/util/List;)Ljava/util/List;

    invoke-virtual {p0, p1, v4}, Lio/flutter/view/g;->R(II)V
    ...
    :cond_12a
    sget-object p2, Lio/flutter/view/g$g;->d:Lio/flutter/view/g$g;
    ...
    :cond_133
    sget-object p2, Lio/flutter/view/g$g;->n:Lio/flutter/view/g$g;
    ...
    invoke-static {v2}, Lio/flutter/view/g$l;->E(Lio/flutter/view/g$l;)Ljava/lang/String;

    move-result-object p3

    invoke-static {v2, p3}, Lio/flutter/view/g$l;->r(Lio/flutter/view/g$l;Ljava/lang/String;)Ljava/lang/String;

    invoke-static {v2}, Lio/flutter/view/g$l;->G(Lio/flutter/view/g$l;)Ljava/util/List;
    ...
    :sswitch_14f
    invoke-direct {p0, v2, p1, p3, v3}, Lio/flutter/view/g;->N(Lio/flutter/view/g$l;ILandroid/os/Bundle;Z)Z
    ...
    :sswitch_154
    invoke-direct {p0, v2, p1, p3, v5}, Lio/flutter/view/g;->N(Lio/flutter/view/g$l;ILandroid/os/Bundle;Z)Z
    ...
    invoke-virtual {p0, p1, v0}, Lio/flutter/view/g;->R(II)V
    ...
    sget-object p3, Lio/flutter/view/g$g;->w:Lio/flutter/view/g$g;

    invoke-virtual {p2, p1, p3}, Lz4/a;->b(ILio/flutter/view/g$g;)V

    const p2, 0x8000

    invoke-virtual {p0, p1, p2}, Lio/flutter/view/g;->R(II)V
    ...
    sget-object p3, Lio/flutter/view/g$g;->c:Lio/flutter/view/g$g;
    ...
    sget-object p3, Lio/flutter/view/g$g;->b:Lio/flutter/view/g$g;
