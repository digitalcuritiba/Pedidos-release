...
.method static constructor <clinit>()V
    ...
    :goto_57
    sput-object v0, Lq/f;->c:Ljava/lang/reflect/Constructor;

    sput-object v1, Lq/f;->b:Ljava/lang/Class;

    sput-object v4, Lq/f;->d:Ljava/lang/reflect/Method;

    sput-object v2, Lq/f;->e:Ljava/lang/reflect/Method;
...
.method private static g(Ljava/lang/Object;Ljava/nio/ByteBuffer;IIZ)Z
    ...
    :try_start_1
    sget-object v1, Lq/f;->d:Ljava/lang/reflect/Method;
...
.method private static h(Ljava/lang/Object;)Landroid/graphics/Typeface;
    ...
    :try_start_1
    sget-object v1, Lq/f;->b:Ljava/lang/Class;
    ...
    sget-object p0, Lq/f;->e:Ljava/lang/reflect/Method;
...
.method public static i()Z
    ...
    sget-object v0, Lq/f;->d:Ljava/lang/reflect/Method;
...
.method private static j()Ljava/lang/Object;
    ...
    :try_start_0
    sget-object v0, Lq/f;->c:Ljava/lang/reflect/Constructor;
...
.method public a(Landroid/content/Context;Lp/c$b;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-static {}, Lq/f;->j()Ljava/lang/Object;
    ...
    invoke-static {p1, p3, v4}, Lq/k;->b(Landroid/content/Context;Landroid/content/res/Resources;I)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p4, v4, v5, v6, v3}, Lq/f;->g(Ljava/lang/Object;Ljava/nio/ByteBuffer;IIZ)Z
    ...
    :cond_33
    invoke-static {p4}, Lq/f;->h(Ljava/lang/Object;)Landroid/graphics/Typeface;
...
.method public b(Landroid/content/Context;Landroid/os/CancellationSignal;[Lu/f$b;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v5}, Lu/f$b;->d()Landroid/net/Uri;
    ...
    invoke-static {p1, p2, v6}, Lq/k;->f(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
    ...
    :cond_29
    invoke-virtual {v5}, Lu/f$b;->c()I

    move-result v6

    invoke-virtual {v5}, Lu/f$b;->e()I

    move-result v8

    invoke-virtual {v5}, Lu/f$b;->f()Z

    move-result v5

    invoke-static {v0, v7, v6, v8, v5}, Lq/f;->g(Ljava/lang/Object;Ljava/nio/ByteBuffer;IIZ)Z
    ...
    :cond_3f
    invoke-static {v0}, Lq/f;->h(Ljava/lang/Object;)Landroid/graphics/Typeface;
