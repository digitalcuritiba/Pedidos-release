...
.method public static declared-synchronized a()Ljava/lang/ClassLoader;
    ...
    :try_start_3
    sget-object v1, Lm1/b;->a:Ljava/lang/ClassLoader;

    if-nez v1, :cond_d

    invoke-static {}, Lm1/b;->b()Ljava/lang/ClassLoader;

    move-result-object v1

    sput-object v1, Lm1/b;->a:Ljava/lang/ClassLoader;
...
.method private static declared-synchronized b()Ljava/lang/ClassLoader;
    ...
    :try_start_3
    sget-object v1, Lm1/b;->b:Ljava/lang/Thread;

    const/4 v2, 0x0

    if-nez v1, :cond_15

    invoke-static {}, Lm1/b;->c()Ljava/lang/Thread;

    move-result-object v1

    sput-object v1, Lm1/b;->b:Ljava/lang/Thread;
    ...
    :try_start_18
    sget-object v3, Lm1/b;->b:Ljava/lang/Thread;
...
.method private static declared-synchronized c()Ljava/lang/Thread;
    ...
    invoke-direct {v1, v8, v4}, Lm1/a;-><init>(Ljava/lang/ThreadGroup;Ljava/lang/String;)V
    :try_end_67
